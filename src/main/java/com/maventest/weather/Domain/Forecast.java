...
public class Forecast
{
    ...
    private Forecast(Location location, CurrentDay currentDay, Atmosphere atmosphere, Wind wind, List<com.maventest.weather.Domain.ExtendedForecast> extendedForecast) {
    ...
    public List<com.maventest.weather.Domain.ExtendedForecast> getExtendedForecast() {
